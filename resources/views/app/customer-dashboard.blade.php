...
<aside class="dashboard-sidebar w-64 bg-white shadow-lg fixed top-16 h-[calc(100vh-4rem)] transition-transform duration-300 z-50">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">Tenant Portal</p>
    </div>

    <nav class="p-4">
        <a href="/customer-dashboard" class="sidebar-link js-nav-link active flex items-center gap-3 px-4 py-3 rounded-lg mb-2">
...
<div class="grid lg:grid-cols-3 gap-8 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <a href="/search-results" class="w-full mt-6 inline-block text-center py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition">Submit New Application</a>
    </div>
</div>
...
<div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/search-results" class="text-purple-600 font-medium hover:text-purple-700">View All (8)</a>
    </div>
