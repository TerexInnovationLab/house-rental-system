...
@section('title', 'Landlord Dashboard - ZikoSpace')
...
<div class="grid lg:grid-cols-3 gap-8 mb-8">
    <div id="viewings" class="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-display font-bold text-gray-900">Upcoming Viewings</h2>
        <a href="/landlord/viewings" class="text-purple-600 font-medium hover:text-purple-700">View All</a>
        </div>
        <div class="space-y-4">
    ...
    <div id="applications" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <a href="/landlord/applications" class="text-purple-600 font-medium hover:text-purple-700">View All</a>
        </div>
