...
@section('sidebar')
<aside class="dashboard-sidebar w-64 bg-gray-900 text-gray-300 fixed top-16 h-[calc(100vh-4rem)] transition-transform duration-300 z-50">
    <div class="p-6 border-b border-gray-800">
        <h1 class="text-2xl font-display font-bold text-white">PropertyHub</h1>
        <p class="text-sm text-gray-400 mt-1">Admin Portal</p>
    </div>

    <nav class="p-4">
        <a href="/admin-dashboard" class="sidebar-link js-nav-link active flex items-center gap-3 px-4 py-3 rounded-lg mb-2">
            <span class="font-medium">Overview</span>
        </a>
        <a href="#users" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-300">
            <span class="font-medium">Users</span>
            <span class="ml-auto bg-purple-600 text-white text-xs px-2 py-1 rounded-full">2.4K</span>
        </a>
        <a href="#properties" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-300">
            <span class="font-medium">Properties</span>
            <span class="ml-auto bg-yellow-600 text-white text-xs px-2 py-1 rounded-full">12</span>
        </a>
        <a href="#disputes" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-300">
        ...
        <div class="border-t border-gray-800 mt-6 pt-6">
            <a href="/profile" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-300">
