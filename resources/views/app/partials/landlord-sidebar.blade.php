<aside class="dashboard-sidebar w-64 bg-white shadow-lg fixed top-16 h-[calc(100vh-4rem)] transition-transform duration-300 z-50 overflow-y-auto">
    <div class="p-6 border-b border-gray-200">
        <p class="text-sm text-gray-600 font-medium">Landlord Portal</p>
    </div>

    <nav class="p-4">
        <a href="/landlord-dashboard" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 {{ request()->is('landlord-dashboard') ? 'active' : '' }}">
        ...
        <a href="/add-property" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700 {{ request()->is('add-property') ? 'active' : '' }}">
            <span class="font-medium">Add Property</span>
        </a>
        <a href="/landlord/viewings" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700 {{ request()->is('landlord/viewings') ? 'active' : '' }}">
        ...
        <a href="/landlord/applications" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700 {{ request()->is('landlord/applications') ? 'active' : '' }}">
