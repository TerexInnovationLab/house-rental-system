<aside class="dashboard-sidebar w-64 bg-white shadow-lg fixed top-16 h-[calc(100vh-4rem)] transition-transform duration-300 z-50">
    ...
    <nav class="p-4">
        <a href="/customer-dashboard" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2">
        ...
        <a href="/customer/saved" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700">
        ...
        <a href="/customer/viewings" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700">
        ...
        <a href="/customer/apply" class="sidebar-link js-nav-link flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-gray-700">
